...
var ourcoursescoursesIdController = require('./coursescoursesIdControllerService');

module.exports.funccoursescoursesIdPARAMETERS = function funccoursescoursesIdPARAMETERS(req, res, next) {
  ourcoursescoursesIdController.funccoursescoursesIdPARAMETERS(req.swagger.params, res, next);
};

module.exports.getCourses = function getCourses(req, res, next) {
  ourcoursescoursesIdController.getCourses(req.swagger.params, res, next);
};

module.exports.updateCourses = function updateCourses(req, res, next) {
  ourcoursescoursesIdController.updateCourses(req.swagger.params, res, next);
};
